...
def generate_dashboard():
    ...
    # สร้าง HTML ตามสไตล์ Modern Dashboard
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    # สร้างไฟล์ PDF และบันทึกไว้ชั่วคราว
    output_pdf = "/tmp/dashboard.pdf"
    HTML(string=html_content).write_pdf(output_pdf)

    # ส่งไฟล์ PDF กลับไปให้ผู้เรียกใช้งานโดยตรง
    return send_file(output_pdf, mimetype='application/pdf', as_attachment=False, download_name='dashboard.pdf')
